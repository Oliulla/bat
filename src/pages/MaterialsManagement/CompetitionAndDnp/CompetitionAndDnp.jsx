...
const CompetitionAndDnp = () => {
  ...
  const [data, setData] = useState(
    Array.from({ length: 89 }, (_, index) => ({
      ...
      companyCategory: `Category ${index + 1}`,
    }))
  );
  ...
  return (
    <div className="space-y-8">
      <div className="rounded-xl bg-white shadow-md">
        <MainHeader title="Add Competition and DNP Material" />
        <Form
          name="basic"
      ...
      <div className="rounded-xl bg-white shadow-md">
        <MainHeader title="View Competition and DNP Material" />
...
export default CompetitionAndDnp;
